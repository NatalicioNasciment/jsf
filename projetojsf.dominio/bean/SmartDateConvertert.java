...
public class SmartDateConvertert implements Converter {
		...
		if(value != null && !value.equals("")){
			if(value.equalsIgnoreCase("hoje")){
				...
				try {
					...
					FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Errou otário", "preeche esse data direito seu proparoxitona");
